...
type Props = {
    invitation: BusinessInvitationContext;
    action: 'Log in' | 'Register';
};

export default function BusinessInvitationAlert({ invitation, action }: Props) {
    return (
        <Alert
            data-test="business-invitation-alert"
        ...
        >
            ...
            <AlertDescription className="text-blue-900 dark:text-blue-100">
                {action} to join the "{invitation.businessName}" business.
            </AlertDescription>
        </Alert>
    );
}
